...
func TestHandleArchive_OK(t *testing.T) {
	t.Parallel()
	app, handler := newTestApp(t)
	app.wordles.(*wordlesServiceMock).ArchiveListFunc = func(_ context.Context, viewerID int64, beforeID int32, limit int32) ([]wordles.ArchiveListItem, bool, error) {
...
func TestHandleArchive_LastPage(t *testing.T) {
	t.Parallel()
	app, handler := newTestApp(t)
	app.wordles.(*wordlesServiceMock).ArchiveListFunc = func(context.Context, int64, int32, int32) ([]wordles.ArchiveListItem, bool, error) {
...
func TestHandleArchive_WithCursorAndLimit(t *testing.T) {
	t.Parallel()
	app, handler := newTestApp(t)
	var gotBeforeID, gotLimit int32
	app.wordles.(*wordlesServiceMock).ArchiveListFunc = func(_ context.Context, _ int64, beforeID int32, limit int32) ([]wordles.ArchiveListItem, bool, error) {
...
func TestHandleArchive_LimitClamped(t *testing.T) {
	...
	app, handler := newTestApp(t)
	var gotLimit int32
	app.wordles.(*wordlesServiceMock).ArchiveListFunc = func(_ context.Context, _ int64, _ int32, limit int32) ([]wordles.ArchiveListItem, bool, error) {
		gotLimit = limit
		return nil, false, nil
	}
...
func TestHandleArchiveWordle_OK(t *testing.T) {
	...
	app.wordles.(*wordlesServiceMock).ArchiveDetailFunc = func(_ context.Context, viewerID int64, wordleID int32, players []wordles.Player) (*wordles.ArchiveDetail, error) {
...
func TestHandleArchiveWordle_ServiceError(t *testing.T) {
	...
	app.wordles.(*wordlesServiceMock).ArchiveDetailFunc = func(context.Context, int64, int32, []wordles.Player) (*wordles.ArchiveDetail, error) {
		return nil, errors.New("db timeout")
	}
