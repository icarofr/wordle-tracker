...
func newTestApp(t *testing.T) (*application, http.Handler) {
	...
	app := &application{
		...
		wordles: &wordlesServiceMock{
			...
			ArchiveListFunc: func(context.Context, int64, int, int) ([]wordles.ArchiveListItem, bool, error) {
				return nil, false, nil
			},
			ArchiveDetailFunc: func(context.Context, int64, int, []wordles.Player) (*wordles.ArchiveDetail, error) { return nil, nil },
