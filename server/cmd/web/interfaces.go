...
type wordlesService interface {
	...
	ArchiveList(ctx context.Context, viewerID int64, beforeID int, limit int) ([]wordles.ArchiveListItem, bool, error)
	ArchiveDetail(ctx context.Context, viewerID int64, wordleID int, players []wordles.Player) (*wordles.ArchiveDetail, error)
