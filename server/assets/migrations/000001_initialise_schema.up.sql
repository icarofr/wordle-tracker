...
CREATE INDEX IF NOT EXISTS whatsapp_messages_sender_index ON whatsapp_messages (sender);
CREATE INDEX IF NOT EXISTS whatsapp_messages_sent_at_index ON whatsapp_messages (sent_at);
