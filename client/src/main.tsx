...
import { AuthProvider, login } from './lib/auth'
...
async function enableMocking() {
  if (import.meta.env.VITE_MOCK_API === 'true') {
    ...
    // With cookie auth, there's no localStorage to check on startup.
    // Set auth state directly so the MSW showcase auto-authenticates.
    login()
  }
}
