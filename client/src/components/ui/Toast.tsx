  ...
  return (
    ...
    >
      ...
      <div class="flex-1 text-sm font-medium">
        <p class="leading-relaxed">{props.toast.message}</p>
        {props.toast.action && (
          <button
            type="button"
            class="mt-2 inline-flex items-center gap-1 rounded-full bg-black/10 px-2.5 py-1 text-xs font-semibold
              transition-colors hover:bg-black/20 dark:bg-white/15 dark:hover:bg-white/25"
            onClick={(e) => {
              e.stopPropagation()
