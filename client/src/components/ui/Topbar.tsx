    ...
    <header class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white/80 px-4 shadow-lg backdrop-blur-xl sm:gap-x-6 sm:px-6 lg:px-8 dark:border-gray-700 dark:bg-gray-900/80">
      ...
      <div class="flex flex-1 items-center justify-between">
        <div class="flex items-center gap-6">
          <div
            class="hidden items-center gap-4 rounded-lg border border-gray-200 bg-gray-50 px-4 py-1.5 transition-colors duration-200 hover:bg-gray-100 lg:flex dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
          >
